 ...
 *   - Backgrounds/graphics keep 1:1 fidelity (rendered by Playwright's bundled Chromium)
 *   - No HTML changes required
 *   - Zero visual loss (the PDF is exactly what the browser prints)
 *
 * Trade-off:
 *   - Text in the PDF is not directly editable afterward (make changes in the HTML)
 *
