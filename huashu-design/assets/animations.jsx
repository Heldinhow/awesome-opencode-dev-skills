 ...
 *
 * Stage + Sprite pattern, inspired by Remotion but lighter weight.
 *
 ...
 *   </Stage>
 *
 * Use `useSprite()` inside Sprite child components to read the current segment progress.
 */
...
(function() {
  ...
  const Easing = {
    ...
    // expoOut: primary Anthropic-style easing (cubic-bezier(0.16, 1, 0.3, 1))
    // Fast launch + slow braking gives numeric elements a sense of physical weight.
