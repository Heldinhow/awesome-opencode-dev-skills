 ...
 *
 * Used to present 2+ static design variations for comparison.
 * Each variation has a label and can expand on hover.
 *
 * Usage:
 *   <DesignCanvas
 ...
 *   </DesignCanvas>
 *
 * Use with React + Babel. Place it in the appropriate script block, then
 * `window.DesignCanvas` and `window.Variation` will be available.
 */
