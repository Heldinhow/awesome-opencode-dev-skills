<sub><b>🌐 English</b> · <a href="README.md">Default README</a></sub>
...
> 📖 **Note**: this skill was built by a Chinese-speaking developer. The demos below are the English parallel versions; the default-named files may still preserve original proper names and handles.
...
| WeChat Official Account | Huashu | Search for the handle `花叔` in WeChat |
